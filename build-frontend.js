...
const browserifyOptions = {
  ...
  standalone: 'providerProxy', // generate a umd file to load directly into browser
};

const OUTPUT_FILE_NAME = 'web3-provider-proxy';
...
browserify(browserifyOptions)
  ...
  .pipe(exorcist(`./dist/${OUTPUT_FILE_NAME}.min.js.map`))
  .pipe(fs.createWriteStream(`./dist/${OUTPUT_FILE_NAME}.min.js`));
